...
find "$search_dir" \
  \( -name "*.jpg" -o -name "*.jpeg" -o -name "*.png" -o -name "*.gif" -o -name "*.bmp" \
  -o -name "*.tiff" -o -name "*.raw" -o -name "*.cr2" -o -name "*.nef" -o -name "*.orf" \
  -o -name "*.sr2" -o -name "*.raf" -o -name "*.heif" -o -name "*.heic" \
  -o -name "*.mp4" -o -name "*.avi" -o -name "*.mkv" -o -name "*.mov" -o -name "*.wmv" \
  -o -name "*.flv" -o -name "*.mpg" -o -name "*.mpeg" -o -name "*.3gp" -o -name "*.rm" \
  -o -name "*.webm" -o -name "*.m4v" -o -name "*.f4v" -o -name "*.ts" \) \
